...
Fig.HelpH = uicontrol('style','pushbutton',...
    ...
    function Params = AppendToolbarHandles(Params)
        Params.Toolbar.StartButton      = Fig.bh(~cellfun(@isempty, strfind(Fig.ButtonFunc, 'Start')));
        Params.Toolbar.StopButton       = Fig.bh(~cellfun(@isempty, strfind(Fig.ButtonFunc, 'Stop')));
        Params.Toolbar.RewardButton     = Fig.bh(~cellfun(@isempty, strfind(Fig.ButtonFunc, 'SCNI_GiveReward')));
        Params.Toolbar.AudioButton      = Fig.bh(~cellfun(@isempty, strfind(Fig.ButtonFunc, 'SCNI_PlaySound')));
        Params.Toolbar.ButtonHandles	= Fig.bh;
        Params.Toolbar.ButtonNames      = Fig.ButtonFunc;
        Params.Toolbar.ButtonDesc       = Fig.ButtonTips;
    end
end
