...
elseif ExpType == 3 %====================== Stereo 3D macaque faces
 	c.StimDir{1} = fullfile(Append, '/khandhadiaap/Blender/MultiInd_Simplified');
    c.BckgrndDir{1} = [];
    c.StimPerCond  	= 90; 
...
c.StimDuration      = 0.3;                                        	% Stimulus on duration (seconds)
